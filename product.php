       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <small class="tittles-pages-logo">SPORTS EXPRESS</small></h1>
            </div>
            <?php
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-xs-12 col-md-4">
                    <div class="dropdown">
                      <button class="btn btn-primary btn-raised dropdown-toggle" type="button" style=background-color:black; id="drpdowncategory" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <span class="input-group-btn">
                              <button class="btn btn-info btn-raised" style=background-color:black; type="submit">Buscar</button>
                          </span>
                        </div>
                      </div>
                    </form>
