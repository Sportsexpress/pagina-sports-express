    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>PEDIDOS <small class="tittles-pages-logo">SPORTS EXPRESS</small></h1>
            </div>
            <br><br><br>
            <div class="row">
                      ...
                      <div class="container-fluid">
                        <div class="row">
                          <div class="col-xs-10 col-xs-offset-1">
                            ...
                            <p class="text-center">
                              <button class="btn btn-lg btn-raised btn-success btn-block" data-toggle="modal" data-target="#PagoModalTran" style="background-color:#3f99d9">Transaccion Bancaria</button>
                            </p>
                          </div>
                        </div>
                      </div>
