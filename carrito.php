    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>CARRITO DE COMPRAS <small class="tittles-pages-logo">SPORTS EXPRESS</small></h1>
            </div>
            <br><br><br>
            <div class="row">
                <div class="col-xs-12">
                    <?php
                        ...
                        if(!empty($_SESSION['carro'])){
                            ...
                            <a href="product.php" class="btn btn-primary btn-lg btn-raised" style="background-color:black;">Ir a Productos</a>';
