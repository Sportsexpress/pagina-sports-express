    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/s.jpg" alt="slider1">
                <div class="carousel-caption">
                    Text Slider 1
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/slider-footbal.jpg" alt="slider2">
                <div class="carousel-caption">
                    Text Slider 2
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/slider-bicycle.jpg" alt="slider3">
                <div class="carousel-caption">
                    Text Slider 3
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">SPORT EXPRESS</span> en un sencillo formulario para poder completar tus pedidos</p>
                        <p><a href="registration.php" style="background-color:black" class="btn btn-info btn-raised btn-block">Registrarse</a></p>   
                   </article>
                </div>
